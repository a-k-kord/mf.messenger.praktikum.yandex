...
var HTTPTransport = (function () {
    function HTTPTransport(baseUrl) {
        ...
        this.get = function (urlPath, options) {
            ...
            var fullUrlPath = "" + urlPath + (queryString(data) || '');
            return _this.request(fullUrlPath, __assign(__assign({}, options), { method: METHODS.GET }));
        };
        this.put = function (urlPath, options) { return _this.request(urlPath, __assign(__assign({}, options), { method: METHODS.PUT })); };
        this.post = function (urlPath, options) { return _this.request(urlPath, __assign(__assign({}, options), { method: METHODS.POST })); };
        this.delete = function (urlPath, options) { return _this.request(urlPath, __assign(__assign({}, options), { method: METHODS.DELETE })); };
